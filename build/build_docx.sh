...
MARKDOWN_FILES=(
    "$SRC_DIR/Введение.md"
    "$SRC_DIR/Анатомия-прямой-кишки.md"
    ...
    "$SRC_DIR/Методика-исследования.md"
    "$SRC_DIR/Выявление-опухоли.md"
    "$SRC_DIR/Выявление-опухоли/Классификация.md"
    "$SRC_DIR/Стадирование-рака-прямой-кишки.md"
    "$SRC_DIR/Стадирование-рака-прямой-кишки/Т-стадирование.md"
    "$SRC_DIR/Стадирование-рака-прямой-кишки/N-стадирование.md"
    "$SRC_DIR/Стадирование-рака-прямой-кишки/Оценка-местной-распространенности.md"
    "$SRC_DIR/Стадирование-рака-прямой-кишки/Оценка-циркулярного-края-резекции.md"
    "$SRC_DIR/Стадирование-рака-прямой-кишки/Оценка-экстрамуральной-венозной-инвазии.md"
    "$SRC_DIR/Структурированный-отчет-при-первичном-МРТ-стадировании-РПК.md"
    "$SRC_DIR/Список-литературы.md"
)
